sap.ui.define([
	...
	return Opa5.extend("ui5.myproductsapp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ui5/myproductsapp/localService/mockserver"], function (mockserver) {
